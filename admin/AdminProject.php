                  ...
                  <div class="span12">
                    <div class="widget purple">
                       ...
                       <td><?php echo $project['studentRegNo']; ?></td>
                          ...
                          <td></td>
                          <td><a class="btn btn-danger" role="button" href="uploads/sourcefiles" download="$project_sourcefiles">Download Zip</a> </ br>
                          <p>

                          </p>
                          <a class="btn btn-danger" role="button" href="uploads/documentation" download="$project_documentation">Download Doc</a>
                          </td>
